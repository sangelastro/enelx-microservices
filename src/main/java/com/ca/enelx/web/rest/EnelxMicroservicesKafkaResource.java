...
@RestController
@RequestMapping("/api/enelx-microservices-kafka")
public class EnelxMicroservicesKafkaResource {
    private final Logger log = LoggerFactory.getLogger(EnelxMicroservicesKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EnelxMicroservicesKafkaResource(KafkaProperties kafkaProperties) {
