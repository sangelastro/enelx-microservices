...
import com.ca.enelx.config.KafkaProperties;
...
class EnelxMicroservicesKafkaResourceIT {
    ...
    void setup() {
        ...
        EnelxMicroservicesKafkaResource kafkaResource = new EnelxMicroservicesKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/enelx-microservices-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/enelx-microservices-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
